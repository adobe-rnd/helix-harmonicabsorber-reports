...
Data from report 9, now using an l estimator for the initial guess
and the scale estimation. [unminified-css/pages+cached](./unminified-css/samples/pages+cached/)
is visibly improved.
