...
# Harmonicabsorber Wed Feb 10 2021 19:14:41 GMT+0100 (Central European Standard Time)

A final repeat of the collection from 12, with machine from 16 using a one standard deviation confidence interval.

Note how it takes just 15 samples (30 because differential sampling) in every case
to generate a result outside the null hypothesis.

Maybe we are able to get this down a bit still by using techniques like linearly weighted averages
to something like 20 seconds in the very best case…
