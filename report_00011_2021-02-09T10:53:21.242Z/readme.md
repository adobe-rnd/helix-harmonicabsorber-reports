...
Re-nalysis on data from report 9.

This serves to validate the updated math for calculating the scoreEstimate; in report 10
we calculated the 2 sigma/95% confidence interval of the mean distribution according to the
central limit theorem and then did all the math on that interval.

In this version we calculate the standard deviation of the mean distribution; do all the math on
that and derive the confidence interval as the very last step. This makes it easier to change the confidence level.
