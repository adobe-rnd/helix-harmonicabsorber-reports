...
set output "report_00006_2020-11-02T20-21-41.718Z/uses-passive-event-listeners/uses-passive-event-listeners_pages+cached+noexternal_pages+cached+noexternal+nosvg_pages+cached+noexternal+noimg.png"
set yrange [NaN:NaN]
