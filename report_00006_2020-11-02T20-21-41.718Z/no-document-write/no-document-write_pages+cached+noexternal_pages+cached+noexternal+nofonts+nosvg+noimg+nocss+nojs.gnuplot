...
set output "report_00006_2020-11-02T20-21-41.718Z/no-document-write/no-document-write_pages+cached+noexternal_pages+cached+noexternal+nofonts+nosvg+noimg+nocss+nojs.png"
set yrange [NaN:NaN]
